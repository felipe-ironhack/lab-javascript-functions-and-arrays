...
//Input: array of numbers / Output: return a number
// return the sum with array.lenght = 1 / Output = element
...
function doesWordExist(wordsArray, searchedWord) {
  ...
  return wordsArray.includes(searchedWord)
}
...
function howManyTimes(array, searchedElement) {
  let count = 0
...
function greatestProduct(matrix) {
  ...
  for (let i = 0; i < matrix.length; i += 1) {
    ...
    for (let j = 0; j < line.length; j += 1) {
      let product = line[j] * line[j + 1] * line[j + 2] * line[j + 3]
